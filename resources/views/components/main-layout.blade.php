...
<body class="bg-gray-900 text-white ">
    <nav class="fixed top-0 inset-x-0 bg-white py-4 z-50">
        <div class="container m-1 p-1 flex justify-between items-center">
            ...
            <div class="">
                <a href="/">
                    <x-application-logo-mini class="  text-gray-500" />
                </a>
            </div>
    ...
    <footer class="py-4 border-t">
        <div class="container">
            <p class='font-bold px-6 rounded ml-2 bg-gray-600 text-white'>&copy; Kondronetworks<span
                class="text-2xl text-indigo-600">.</span> 2023</p>
        </div>
    </footer>
