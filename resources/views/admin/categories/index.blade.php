                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Courses Count</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap">{{ $category->courses_count }}</td>
